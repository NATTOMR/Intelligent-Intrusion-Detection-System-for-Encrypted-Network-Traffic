...
def run_hybrid_ids():
    ...
    print(
        f"XGBoost labeled {len(benign_indices)} packets as benign. Passing these to Autoencoder..."
    )
    ...
    if len(benign_indices) > 0:
        ...
        print(
            f"Autoencoder caught {anomalies_found} unknown anomalies hiding in the benign traffic!"
        )
